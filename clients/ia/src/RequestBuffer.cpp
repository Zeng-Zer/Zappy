...
void RequestBuffer::push(std::string request, std::function<bool(Player&, std::string&)> responce_function) {
  if (!isFull()) {
...
void RequestBuffer::push(std::pair<std::string, std::function<bool(Player&, std::string&)>> request) {
  if (!isFull()) {
...
std::pair<std::string, std::function<bool(Player&, std::string&)>> RequestBuffer::front(void) const {
